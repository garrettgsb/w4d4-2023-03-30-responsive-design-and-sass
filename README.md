...
* Just use Bootstrap (🤮) or some other CSS framework or component library
...
* [Some eCommerce Site](https://www.backfireboards.com/) - Very bread-and-butter responsiveness
* [BBC.com](https://bbc.com) - More advanced information architecture at different viewport sizes
* [Peaceful Restaurant](http://peacefulrestaurant.com/) - ~Uh oh.~ Their site actually got alot better than it used to be!
* [Amazon](http://amazon.ca) - How does Amazon handle responsiveness?
* [Guilt & Company's _old_ website](https://web.archive.org/web/20190714063732/http://www.guiltandcompany.com/) - Beautiful site, _not_ mobile responsive... Their new site is responsive but boring 😏
